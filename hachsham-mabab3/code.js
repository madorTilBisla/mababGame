...
var arrGameMatrix = [[BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, FOOD_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, FOOD_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, FOOD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN ,BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN , BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, FOOD_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, FOOD_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, EMPTY_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN, FOOD_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN, FOOD_SIGN, NOTHING_SIGN, NOTHING_SIGN,  BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, FOOD_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, FOOD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, NOTHING_SIGN, FOOD_SIGN, NOTHING_SIGN, BOARD_SIGN],
                    [BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN, BOARD_SIGN, NOTHING_SIGN, NOTHING_SIGN, NOTHING_SIGN, BOARD_SIGN],
...
var questions = [{
    ...
    "answer2": "גיוון בחיזוקים, חיזוק פרופורציונלי ומיידי",
    "answer3": "שימוש בחיזוק מוכר על מנת שלא לבלבל את החניך, חיזוק מיידי. ",
    "answer4": "גיוון בחיזוקים, לתת גם חיובי וגם שלילי, חיזוקים תוך כדי הפעלה",
    "correctAnswer": "2"
}, {
    "subject": "זיכרון",
    "question": "מהן 2 התקלות שיכולות להיות בשליפה?",
    ...
    "answer1": "העברת התוכן במלואו",
    "answer2": "התוצר הסופי שיושג בסוף תהליכי הלמידה",
    "answer3": "המאמץ הנדרש מהלומד ברמת הידע",
    "answer4": "התנהגות נאותה של הלומד בזמן הלמידה",
    "correctAnswer": "2"
}, {
    "subject": "רמות חשיבה",
    ...
    "subject": "רמות חשיבה",
    "question": " הנך מדריך בהכשרה, נכנסת לכיתה באיחור של 30 דקות לכן האשמת את מכונת הצילום שלא עובדת ובכך דרכת על מוקש:",
    "answer1": "ייחוס",
    "answer2": "ציפיות",
    "answer3": "סטריאוטיפ",
    ...
    "subject": 'מבנה יח״ל',
    "question": "במהלך השיעור רמת הקשב של החניכים הייתה ירודה, לפי אילו מרכיבים בגוף השיעור ניתן היה למנוע זאת?",
    ...
    "subject": 'מבנה יח״ל',
    "question": "במהלך השיעור יוסי החניך ישב מהורהר ולא הבין למה הוא צריך ללמוד את השיעור הזה. כיצד יכול המפקד למנוע את תחושותיו של יוסי בתחילת השיעור?",
    ...
    "answer2": 'לחסוך בזמן, בנייה על פי מבנה יח"ל, וידוא טכני',
    "answer3": "עיצוב פשוט, לגוון באמצעים, בקיאות ומקצועיות",
    "answer4": 'בנייה על פי מבנה יח"ל, עיצוב פשוט ומתון, בקיאות ומקצועיות, וידוא טכני',
    "correctAnswer": "4"
}, {
    "subject": "הפעלות",
    "question": "מהי ההגדרה להפעלה?",
    "answer1": "פעולה יזומה של הפעלת כוח בדרך מבצעית",
    "answer2": 'פעולה יזומה שמטרתה להביא את החניכים להתנסות ע"י למידה',
    "answer3": "פעילות הווי וגיבוש יזומה בזמן שיעור",
    ...
    "answer2": 'התמודדות עם היחסים, פיקוד ושליטה, תכנון ודינמיות, אינטרקציה, פו״ש',
    "answer3": 'פו״ש, התמודדות עם הסחים, יצירתיות, בטיחות, מוטיבציה',
    "answer4": 'מוטיבציה, התמודדות עם הסחים, פו״ש, תכנון ודינמיות, בטיחות',
    "correctAnswer": "4"
}, {
    ...
    "subject": 'מת״י',
    "question": "כאשר ישנה בעיה בתפישה, היא נובעת ככל הנראה מ:",
    ...
    "subject": 'שיעור מסדר',
    "question": "מהן שלושת מטרות המסדר?",
    "answer1": "חניכה, גיבוש, פיתוח",
    "answer2": "התפתחות, בדיקת משמעת, פיתוח אישי",
    "answer3": "הפעלה, השאלה, הגדלת ראש",
    "answer4": "בדיקת תקינות הציוד, משמעת, פיתוח",
    "correctAnswer": "4"
}, {
    "subject": 'שיעור מסדר',
    "question": "מהו סדר סיכום המסדר?",
    "answer1": 'חזרת חניכים על הריג׳קטים, סיכום מפקד, סיכום חנת"ר',
    "answer2": 'סיכום מפקד, התייחסויות חניכים',
    "answer3": 'חזרת חניכים על ריג׳קטים, סיכום חנת"ר, סיכום מפקד',
    "answer4": 'סיכום ביניים של החנת"ר, סיכום מפקד, סיכום מ"מ, סיכום מפקד מסלול',
    "correctAnswer": "3"
}];
...
function initGame(){
    ...
    var nRandomNumber;
    // draws 10 different numbers
    for(var i = 1; i <= 10; i++){
        nRandomNumber = Math.floor(Math.random() * (30 - 0) + 0);
    ...
    //adds the food and board to the html
    for(var nRow = BOARD_SIZE; nRow < MAX_ROW - BOARD_SIZE; nRow++){
        ...
        for(var nCol = BOARD_SIZE; nCol < MAX_COL - BOARD_SIZE; nCol++){
            if(arrGameMatrix[nRow][nCol] === FOOD_SIGN){
                ...
                newFood.setAttribute("src", "dot.png");
                newFood.setAttribute("alt", "food");
                newFood.setAttribute("id", String(nRow+ ", "+nCol));
                newFood.className += "food";
                newRow.appendChild(newFood);
            } else if (arrGameMatrix[nRow][nCol] === NOTHING_SIGN){
                newNothing = document.createElement("img");
                newNothing.setAttribute("src", "dot-3.png");
                newNothing.setAttribute("alt", "nothing");
                newNothing.setAttribute("id", String(nRow+ ", "+nCol));
                newNothing.className += "nothing";
                newRow.appendChild(newNothing);
            } else{
    ...
    instructions.innerHTML += "<div class='instructionsTitle'>הוראות</div><br>" + 
                                "<div class='instructionsBody'>השתמשו בחצים על גבי המסך כדי לזוז. <br> רדפו אחר כל השאלות וענו נכונה כדי לצבור נקודות! <br> כל נקודה רגילה על המסך מעניקה נקודה אחת וכל תשובה נכונה מעניקה 10 נקודות. <br> שחקו, למדו, תרגלו ותהנו!</div><br>" + 
                                "<button id='buttonInstructions' class='instructionsButton'>חזרה</button>";
    instructions.className += "instructions";
    document.body.appendChild(instructions);  
    document.getElementById("buttonInstructions").addEventListener("click", backInstructions);
...
function findMyNum(nRandomNumber){
    ...
    for(var nLength = 0; nLength < 10; nLength++){
...
function movePacman(dirToMove){
    ...
    if(arrGameMatrix[nNewPacManRow][nNewPacManCol] !== BOARD_SIGN){
        ...
        } else if(arrGameMatrix[nCurrPacManRow][nCurrPacManCol] === NOTHING_SIGN){
            nScoreCounter += NOTHING_DOS_TO_ADD;
            elScore.innerHTML = "ניקוד : " + nScoreCounter;
...
function endScreen(){
    ...
    congrats.innerHTML = "כל הכבוד! סיימת את הלומדה";
    document.body.appendChild(congrats);

    var confetti = document.createElement("img");
    confetti.className += "confetti";
    confetti.setAttribute("id", "confettiId");
    confetti.setAttribute("src", "confetti.png");
    document.body.appendChild(confetti);

    var scoreFinale = document.createElement("div");
    scoreFinale.className += "finalScore";
    scoreFinale.innerHTML = "הניקוד הסופי: " + nScoreCounter;
    document.body.appendChild(scoreFinale);

    var credits = document.createElement("div");
    credits.className += "credits";
    credits.innerHTML = 'מ. מסלול נפ״ה : עידן ינובסקי' + "<br>" +
                        'מ. מדור טי״ל ואימונים : מילי קנר' + "<br>" +
                        'מ״ע מדור טי״ל : שחר מהלל' + "<br>" +
                        'כותבת לומדה : עדן שר שלום' + "<br>" +
                        'מ. מדור הכש״מ : שרון כרמלי' + "<br>" +
                        'מומחי תוכן : מדור הכש״מ' + "<br>";
   document.body.appendChild(credits);

   //move the solider
    if((window.innerWidth >= "319") && (window.innerWidth <= "460")){
        document.getElementById("soliderImg").style.left = "6vw";
    } else if((window.innerWidth >= "460") && (window.innerWidth <= "736")){
        document.getElementById("soliderImg").style.left = "6vw";
        document.getElementById("confettiId").style.left = "0vw";
    } else if((window.innerWidth >= "737") && (window.innerWidth <= "768")){
        document.getElementById("soliderImg").style.left = "6vw";
    } else if((window.innerWidth >= "768") && (window.innerWidth <= "992")){
        
    } else if(window.innerWidth >= "992"){
        document.getElementById("soliderImg").style.left = "2vw";
    }  
